package com.kopo_team4.auth_backend.domain.account.service;
...
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalAccountDetailRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalAccountRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalBalanceRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalTransactionRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalWithdrawRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalDepositRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.IrpTransferRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalIrpWithdrawRequest;
import com.kopo_team4.auth_backend.domain.account.dto.request.ExternalIrpDepositRequest;
...
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalAccountDetailResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalAccountResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalBalanceResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalTransactionResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalWithdrawResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalDepositResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.IrpTransferResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalIrpWithdrawResponse;
import com.kopo_team4.auth_backend.domain.account.dto.response.ExternalIrpDepositResponse;
...
import com.kopo_team4.auth_backend.domain.account.repository.AccountRepository;
import com.kopo_team4.auth_backend.domain.bank.entity.BankCode;
import com.kopo_team4.auth_backend.domain.bank.repository.BankCodeRepository;
import com.kopo_team4.auth_backend.domain.user.entity.User;
import com.kopo_team4.auth_backend.domain.user.repository.UserRepository;
